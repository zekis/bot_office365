    ...
    cards = {
        ...
        "actions": [
            ...
            },
            {
                ...
                "mode": "secondary",
                "data": {
                    "acDecision": f"Please use the DRAFT_REPLY_TO_EMAIL tool using ConverstationID: {email.conversation_id} to draft a response from Chad-Bot on behalf of {ai_config.FRIENDLY_NAME}"
                }
            },
            {
                "type": "Action.Submit",
                ...
                "mode": "secondary",
                "data": {
                    "acDecision": f"Please use the DRAFT_FORWARD_TO_EMAIL tool using ConverstationID: {email.conversation_id} to draft a response from Chad-Bot on behalf of {ai_config.FRIENDLY_NAME}"
                }
