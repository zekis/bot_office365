    ...
    cards = {
        ...
        "actions": [
            ...
            },
            {
                ...
                "mode": "secondary",
                "data": {
                    "acDecision": f"Please use the office365 assistant and its DRAFT_REPLY_TO_EMAIL tool using ConverstationID: {email.conversation_id} to draft a response from Chad-Bot on behalf of {bot_config.FRIENDLY_NAME}"
                }
            },
            {
                "type": "Action.Submit",
                ...
                "mode": "secondary",
                "data": {
                    "acDecision": f"Please use the office365 assistant and its DRAFT_FORWARD_TO_EMAIL tool using ConverstationID: {email.conversation_id} to draft a response from Chad-Bot on behalf of {bot_config.FRIENDLY_NAME}"
                }
        ...
        "actions": [
            {
                ...
                "title": "Send",
                "data": {
                    "acDecision": f"Please send an email using the office365 assistant and its SEND_EMAIL tool to: {recipients}, subject: {email.subject}, body: {response}"
                },
            ...
            },
            {
                ...
                "mode": "secondary",
                "data": {
                    "acDecision": f"Please use the office365 assistant and its DRAFT_EMAIL tool using ConverstationID: {email.conversation_id} to create a new draft based on the current draft: {response}"
                }
            }
        ...
        "actions": [
            {
                ...
                "title": "Send",
                "data": {
                    "acDecision": f"Please send an email using office365 assistant and its REPLY_TO_EMAIL tool using ConversationID: {email.conversation_id} with Body: {response}"
                },
                "associatedInputs": "None"
            },
            {
                ...
                "mode": "secondary",
                "data": {
                    "acDecision": f"Please use the office365 assistant and its DRAFT_REPLY_TO_EMAIL tool using ConverstationID: {email.conversation_id} to create a new draft based on the current draft: {response}"
                }
            }
        ...
        "actions": [
            {
                ...
                "title": "Send",
                "data": {
                    "acDecision": f"Please send an email using the office365 assistant and its FORWARD_TO_EMAIL tool using ConversationID: {email.conversation_id} to: {recipients}, with Body: {response}"
                },
                "associatedInputs": "None"
            },
            {
                ...
                "mode": "secondary",
                "data": {
                    "acDecision": f"Please use the office365 assistant and its DRAFT_FORWARD_TO_EMAIL tool using ConverstationID: {email.conversation_id} to create a new draft based on the current draft: {response}"
                }
            }
